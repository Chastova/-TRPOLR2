...
namespace TRPOLR2
{
    static class ClassCreator
    {
        ...
        public static Организация Организация()
		{
            ...
            string юридическийAдрес = Console.ReadLine();
            Console.WriteLine("Введите фактический адрес");
            string фактическийAдрес = Console.ReadLine();
            return new Организация(название, юридическийAдрес, фактическийAдрес, Сотрудник()) ;
